...
image2 = Image.open('reference_img_login_register.png')
image2 = image2.resize((w,h), Image.LANCZOS)
...
title=tk.Label(root, text="Login Here", font=("Algerian", 25, "bold"),bd=5,bg="Sky blue",fg="white")
title.place(x=860,y=300,width=350, height=100)
    
    
Login_frame=tk.Frame(root,bg="#E6EBFF")
Login_frame.place(x=790,y=410)
        
logolbl=tk.Label(Login_frame,bd=0).grid(row=2,columnspan=1,pady=10)
...
btn_log=tk.Button(Login_frame,text="SIGN IN",command=login,width=15,font=("Times new roman", 14, "bold"),bg="white",fg="black")
btn_log.grid(row=3,column=1,pady=10)
btn_reg=tk.Button(Login_frame,text="Create Account",command=registration,width=15,font=("Times new roman", 14, "bold"),bg="white",fg="black")
