...
image2 = image2.resize((2000, 900), Image.LANCZOS)
...
frame_alpr = tk.LabelFrame(window, text=" --Process-- ", width=1000, height=550, bd=5, font=('times', 14, ' bold '),bg="#E6EBFF")
frame_alpr.grid(row=0, column=0, sticky='nw')
frame_alpr.place(x=200, y=120)

 # , relwidth=1, relheight=1)


l1 = tk.Label(window, text="Registration Form", font=("Times new roman", 30, "bold"), bg="Sky Blue", fg="white")
l1.place(x=550, y=50)

# that is for label1 registration
image2 = Image.open('register_photo.png')
...
l7.place(x=230, y=350)
# gender
tk.Radiobutton(window, text="Male", padx=5, width=5, bg="snow", font=("bold", 15), variable=var, value=1).place(x=430,
                                                                                                                y=350)
...
t9.place(x=430, y=500)

l10 = tk.Label(window, text="Confirm Password:", width=13, font=("Times new roman", 15, "bold"), bg="snow")
l10.place(x=230, y=550)

t10 = tk.Entry(window, textvar=password1, width=20, font=('', 15), show="*")
t10.place(x=430, y=550)

btn = tk.Button(window, text="SIGN UP", bg="Sky blue",font=("",20),fg="white", width=9, height=1, command=insert)
